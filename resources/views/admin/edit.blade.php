                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                @endif
                                <form class="form-horizontal" method="post" action='{{ url("admin/$airData->id") }}'>
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" required class="form-control" id="datepicker"
                                                   ...
                                                   value="{{ old('date_time') ?: \Carbon\Carbon::parse($airData->date_time)->format('Y-m-d H:i') }}">
                                        </div>
                                    </div>
                                            ...
                                            <select class="form-control" name="location_id" required>
                                                ...
                                                @foreach($locations as  $location)
                                                    <option value="{{ $location->id }}"
                                                            @if(old('location_id') == $location->id) selected @elseif($airData->location_id == $location->id) selected @endif> {{ $location->name }} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <select class="form-control" name="air_type_id" required>
                                                ...
                                                @foreach($air_types as  $air_type)
                                                    <option value="{{ $air_type->id }}"
                                                            @if(old('air_type_id') == $air_type->id) selected @elseif($airData->air_type_id == $air_type->id) selected @endif> {{ $air_type->name }} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
